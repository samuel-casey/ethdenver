...
import LocalStorageProvider, { Updater as LocalStorageUpdater } from './contexts/local-storage';

// Blockchain
import { createGravatar } from './blockchain/createGravatar';
...
class App extends Component {
  ...
  createGravatar = (newGravatar) => {
    console.log(newGravatar);
    createGravatar();
  }
        ...
        <WalletContextProvider>
          ...
          <div className="App">
            <Grid container direction="column">
              ...
              />
              <Form onSubmit={this.createGravatar} />
              <br/>
              <br/>
              <Grid item>
                <Grid container>
